...
export const AskMePage: React.FC = () => {
    ...
    const getQuestion = async (referenceId: string) => {
        const docRef = doc(db, "questions", referenceId) as DocumentReference<QuestionType>;
    ...
    return <FunnyQuestion question={question} option={option} optionUnreachable={optionUnreachable} />
}